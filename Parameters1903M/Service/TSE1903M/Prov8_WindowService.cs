...
{
    internal class Prov8_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov8_Window GetProvWindow() => Application.Current.Windows.OfType<Prov8_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov8_Window window = Application.Current.Windows.OfType<Prov8_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov8_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
