...
{
    internal class Prov5_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov5_Window GetProvWindow() => Application.Current.Windows.OfType<Prov5_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov5_Window window = Application.Current.Windows.OfType<Prov5_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov5_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
