...
{
    internal class Prov15_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov15_Window GetProvWindow() => Application.Current.Windows.OfType<Prov15_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov15_Window window = Application.Current.Windows.OfType<Prov15_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov15_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
