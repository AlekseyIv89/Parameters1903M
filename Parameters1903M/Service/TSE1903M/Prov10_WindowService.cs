...
{
    internal class Prov10_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov10_Window GetProvWindow() => Application.Current.Windows.OfType<Prov10_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov10_Window window = Application.Current.Windows.OfType<Prov10_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov10_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
