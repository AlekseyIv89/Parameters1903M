...
{
    internal class Prov3_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov3_Window GetProvWindow() => Application.Current.Windows.OfType<Prov3_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov3_Window window = Application.Current.Windows.OfType<Prov3_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov3_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
