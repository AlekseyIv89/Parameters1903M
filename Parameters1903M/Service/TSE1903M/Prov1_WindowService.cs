...
{
    internal class Prov1_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov1_Window GetProvWindow() => Application.Current.Windows.OfType<Prov1_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov1_Window window = Application.Current.Windows.OfType<Prov1_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov1_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
