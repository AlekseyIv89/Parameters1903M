...
{
    internal class Prov16_WindowService : ProvMeasureWindowService, IWindowService
    {
        public Prov16_Window GetProvWindow() => Application.Current.Windows.OfType<Prov16_Window>().FirstOrDefault();
        ...
        public void OpenDialog(object param)
        {
            ...
            {
                Prov16_Window window = Application.Current.Windows.OfType<Prov16_Window>().FirstOrDefault();
                if (window == null)
                {
                    window = new Prov16_Window(parameter) { Owner = Application.Current.MainWindow };
                }
                window.ShowDialog();
