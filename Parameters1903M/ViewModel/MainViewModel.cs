    ...
    internal class MainViewModel : BaseViewModel
    {
        ...
        public MainViewModel()
        {
            ...
            Parameters = new List<Parameter>
            {
                ...
                new Parameter() { Num = "3", Name = "Дрейф нуля ДУ", Unit = "...″", Digits = 2 },
                new Parameter() { Num = "4", Name = "Переменная составляющая вых. напряжения ДУ, U~", Unit = "мВ", Digits = 0 },
                new Parameter() { Num = "5", Name = "Угол крепления механических упоров", Unit = "...ʹ", Digits = 1 },
                ...
                new Parameter() { Num = "8", Name = "Стабильность положения ОЧ", Unit = "...″", Digits = 1 },
                ...
                new Parameter() { Num = "15", Name = "Температурный коэффициент, Kt", Unit = "%/°С", Digits = 4 },
